...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($login_input) && !empty($password)) {
        // البحث عن الطالب باستخدام رقم الهاتف أو الإيميل
        ...
        $msg = "<div style='background: #ef4444; color: white; padding: 12px; border-radius: 8px; text-align: center; font-weight: bold; margin-bottom: 15px;'>⚠️ يرجى ملء جميع الحقول المطلوبة.</div>";
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        body { font-family: 'Segoe UI', Tahoma, sans-serif; margin: 0; padding: 0; background: var(--bg); color: #333; display: flex; justify-content: center; align-items: center; min-height: 100vh; }
        .card { background: var(--white); padding: 40px; border-radius: 12px; box-shadow: 0 10px 25px rgba(0,0,0,0.08); width: 100%; max-width: 400px; border: 1px solid #e2e8f0; box-sizing: border-box; margin: 20px; }
